...
module TOP_DW02_mult_0 ( A, B, TC, PRODUCT );
  ...
  INVX2 U13 ( .A(n9), .Y(PRODUCT[5]) );
  XNOR2X1 U14 ( .A(n6), .B(n15), .Y(PRODUCT[7]) );
  INVX2 U15 ( .A(B[2]), .Y(n22) );
  INVX2 U16 ( .A(B[1]), .Y(n23) );
  INVX2 U17 ( .A(B[3]), .Y(n21) );
  INVX2 U18 ( .A(B[0]), .Y(n24) );
  INVX2 U19 ( .A(A[3]), .Y(n17) );
  INVX2 U20 ( .A(A[1]), .Y(n19) );
  INVX2 U21 ( .A(A[2]), .Y(n18) );
  INVX2 U22 ( .A(A[0]), .Y(n20) );
...
module TOP ( a, b, clk, rst, sel1, sel2, sel3, sel4, out );
  ...
  NOR3BX4 U54 ( .AN(sel3), .B(n55), .C(sel2), .Y(n20) );
  ...
  INVX2 U70 ( .A(n19), .Y(n68) );
  CLKBUFX32 U71 ( .A(n71), .Y(out[7]) );
  OR2X2 U72 ( .A(n68), .B(n64), .Y(n31) );
  OR2X2 U73 ( .A(n68), .B(n63), .Y(n32) );
  OR2X2 U74 ( .A(n68), .B(n62), .Y(n33) );
  CLKINVX1 U75 ( .A(rst), .Y(n34) );
  INVX2 U76 ( .A(n34), .Y(n35) );
  INVXL U77 ( .A(clk), .Y(n36) );
  INVX4 U78 ( .A(n36), .Y(n37) );
  INVX4 U79 ( .A(n78), .Y(n38) );
  CLKINVX20 U80 ( .A(n38), .Y(out[0]) );
  INVX4 U81 ( .A(n77), .Y(n40) );
  CLKINVX20 U82 ( .A(n40), .Y(out[1]) );
  INVX4 U83 ( .A(n76), .Y(n42) );
  CLKINVX20 U84 ( .A(n42), .Y(out[2]) );
  INVX4 U85 ( .A(n75), .Y(n44) );
  CLKINVX20 U86 ( .A(n44), .Y(out[3]) );
  INVX4 U87 ( .A(n74), .Y(n46) );
  CLKINVX20 U88 ( .A(n46), .Y(out[4]) );
  INVX4 U89 ( .A(n73), .Y(n48) );
  CLKINVX20 U90 ( .A(n48), .Y(out[5]) );
  INVX4 U91 ( .A(n72), .Y(n50) );
  CLKINVX20 U92 ( .A(n50), .Y(out[6]) );
  NAND2BX2 U93 ( .AN(\sub_34/carry [4]), .B(n19), .Y(n21) );
  OAI2BB1XL U94 ( .A0N(N36), .A1N(n55), .B0(n21), .Y(N58) );
  INVX2 U95 ( .A(n68), .Y(n53) );
  NOR4BX2 U96 ( .AN(sel4), .B(n55), .C(sel2), .D(sel3), .Y(n19) );
  INVX2 U97 ( .A(n57), .Y(n66) );
  INVX2 U98 ( .A(n20), .Y(n69) );
  NOR2X2 U99 ( .A(n69), .B(n58), .Y(a_3[3]) );
  NOR2X2 U100 ( .A(n69), .B(n59), .Y(a_3[2]) );
  NOR2X2 U101 ( .A(n69), .B(n60), .Y(a_3[1]) );
  NOR2X2 U102 ( .A(n65), .B(n69), .Y(b_3[0]) );
  NOR2X2 U103 ( .A(n68), .B(n61), .Y(a_4[0]) );
  NOR2X2 U104 ( .A(n64), .B(n69), .Y(b_3[1]) );
  NOR2X2 U105 ( .A(n63), .B(n69), .Y(b_3[2]) );
  NOR2X2 U106 ( .A(n65), .B(n57), .Y(b_2[0]) );
  NOR2X2 U107 ( .A(n62), .B(n69), .Y(b_3[3]) );
  NOR2X2 U108 ( .A(n57), .B(n61), .Y(a_2[0]) );
  OAI2BB1X1 U109 ( .A0N(N34), .A1N(n55), .B0(n21), .Y(N56) );
  OAI2BB1X1 U110 ( .A0N(N35), .A1N(n55), .B0(n21), .Y(N57) );
  NOR2X2 U111 ( .A(n63), .B(n56), .Y(b_1[2]) );
  NOR2X2 U112 ( .A(n64), .B(n56), .Y(b_1[1]) );
  NOR2X2 U113 ( .A(n62), .B(n56), .Y(b_1[3]) );
  NOR2X2 U114 ( .A(n65), .B(n56), .Y(b_1[0]) );
  NOR2X2 U115 ( .A(n56), .B(n58), .Y(a_1[3]) );
  NOR2X2 U116 ( .A(n56), .B(n60), .Y(a_1[1]) );
  NOR2X2 U117 ( .A(n56), .B(n59), .Y(a_1[2]) );
  NOR2X2 U118 ( .A(n56), .B(n61), .Y(a_1[0]) );
  NAND2X2 U119 ( .A(n29), .B(n30), .Y(N51) );
  AOI22XL U120 ( .A0(N37), .A1(n66), .B0(N29), .B1(n55), .Y(n29) );
  AOI22XL U121 ( .A0(N46), .A1(n53), .B0(N42), .B1(n20), .Y(n30) );
  NAND2X2 U122 ( .A(n27), .B(n28), .Y(N52) );
  AOI22XL U123 ( .A0(N38), .A1(n66), .B0(N30), .B1(n55), .Y(n27) );
  AOI22XL U124 ( .A0(N47), .A1(n53), .B0(N43), .B1(n20), .Y(n28) );
  NAND2X2 U125 ( .A(n25), .B(n26), .Y(N53) );
  AOI22XL U126 ( .A0(N39), .A1(n66), .B0(N31), .B1(n55), .Y(n25) );
  AOI22XL U127 ( .A0(N48), .A1(n53), .B0(N44), .B1(n20), .Y(n26) );
  NAND2X2 U128 ( .A(n23), .B(n24), .Y(N54) );
  AOI22XL U129 ( .A0(N40), .A1(n66), .B0(N32), .B1(n55), .Y(n23) );
  AOI22XL U130 ( .A0(N49), .A1(n53), .B0(N45), .B1(n20), .Y(n24) );
  CLKBUFX4 U131 ( .A(n67), .Y(n56) );
  INVX2 U132 ( .A(n55), .Y(n67) );
  CLKBUFX4 U133 ( .A(n18), .Y(n57) );
  NAND2X2 U134 ( .A(sel2), .B(n56), .Y(n18) );
  NOR2X2 U135 ( .A(n69), .B(n61), .Y(a_3[0]) );
  OR2X2 U136 ( .A(n68), .B(n65), .Y(n54) );
  ADDFX1 U137 ( .A(a_2[1]), .B(b_2[1]), .CI(\add_32/carry [1]), .CO(
        \add_32/carry [2]), .S(N38) );
  NOR2X2 U138 ( .A(n57), .B(n60), .Y(a_2[1]) );
  NOR2X2 U139 ( .A(n64), .B(n57), .Y(b_2[1]) );
  ADDFX1 U140 ( .A(a_4[1]), .B(n31), .CI(\sub_34/carry [1]), .CO(
        \sub_34/carry [2]), .S(N47) );
  NOR2X2 U141 ( .A(n68), .B(n60), .Y(a_4[1]) );
  ADDFX1 U142 ( .A(a_2[2]), .B(b_2[2]), .CI(\add_32/carry [2]), .CO(
        \add_32/carry [3]), .S(N39) );
  NOR2X2 U143 ( .A(n57), .B(n59), .Y(a_2[2]) );
  NOR2X2 U144 ( .A(n63), .B(n57), .Y(b_2[2]) );
  ADDFX1 U145 ( .A(a_4[2]), .B(n32), .CI(\sub_34/carry [2]), .CO(
        \sub_34/carry [3]), .S(N48) );
  NOR2X2 U146 ( .A(n68), .B(n59), .Y(a_4[2]) );
  OAI2BB1X1 U147 ( .A0N(N33), .A1N(n55), .B0(n22), .Y(N55) );
  AOI21BX2 U148 ( .A0(N41), .A1(n66), .B0N(n21), .Y(n22) );
  ADDFX1 U149 ( .A(a_4[3]), .B(n33), .CI(\sub_34/carry [3]), .CO(
        \sub_34/carry [4]), .S(N49) );
  NOR2X2 U150 ( .A(n68), .B(n58), .Y(a_4[3]) );
  ADDFX1 U151 ( .A(a_2[3]), .B(b_2[3]), .CI(\add_32/carry [3]), .CO(N41), .S(
        N40) );
  NOR2X2 U152 ( .A(n57), .B(n58), .Y(a_2[3]) );
  NOR2X2 U153 ( .A(n62), .B(n57), .Y(b_2[3]) );
  INVX2 U154 ( .A(b[2]), .Y(n63) );
  INVX2 U155 ( .A(b[3]), .Y(n62) );
  INVX2 U156 ( .A(b[1]), .Y(n64) );
  INVX2 U157 ( .A(b[0]), .Y(n65) );
  INVX2 U158 ( .A(a[2]), .Y(n59) );
  INVX2 U159 ( .A(a[3]), .Y(n58) );
  INVX2 U160 ( .A(a[0]), .Y(n61) );
  INVX2 U161 ( .A(a[1]), .Y(n60) );
  CLKBUFX4 U162 ( .A(sel1), .Y(n55) );
  AND2X1 U163 ( .A(a_2[0]), .B(b_2[0]), .Y(\add_32/carry [1]) );
  XOR2X1 U164 ( .A(b_2[0]), .B(a_2[0]), .Y(N37) );
  OR2X1 U165 ( .A(n54), .B(a_4[0]), .Y(\sub_34/carry [1]) );
  XNOR2X1 U166 ( .A(a_4[0]), .B(n54), .Y(N46) );
endmodule
